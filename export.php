        ...
        foreach($q_vals as $row) {
            ...
            if(true) {
                ...
                if(isset($q_vals_sub_1[0]) && $q_vals_sub_1[0]!=null) {
                    $objPHPExcel->getActiveSheet()->setCellValue('A'.$index,($index-1));
                    $objPHPExcel->getActiveSheet()->setCellValue('B'.$index,$row['customer_id']);
                    $objPHPExcel->getActiveSheet()->setCellValue('C'.$index,$q_vals_sub_1[0]['customer_name']);
                    $objPHPExcel->getActiveSheet()->setCellValue('D'.$index,$q_vals_sub_1[0]['customer_email']);
